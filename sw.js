...
const CONTRACT_VERSION = 'service-worker-update-contract-1.1-clean-user-package';
const PRODUCT_VERSION = '0.6.0-product-alpha.32';
const CACHE_PREFIX = 'ghe-usuario-final-';
const CORE_CACHE = `${CACHE_PREFIX}${APP_VERSION}-${PRODUCT_VERSION}-P12-5-core`;
const RUNTIME_CACHE = `${CACHE_PREFIX}${APP_VERSION}-${PRODUCT_VERSION}-P12-5-runtime`;
const CORE_ASSETS = [
  "./",
  "./index.html",
